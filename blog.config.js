...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Blackroom', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'hhh ', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blackroom.vercel.app/', // 网站地址
